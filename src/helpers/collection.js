  ...
  "0x38": [
    {
      index: 1,
      image:
        "https://nftstorage.link/ipfs/bafkreihwtsrptgbgtawpjn2lhzbphkvmm2jpvqnq7wlbnkwafbcnmbutyu",
      banner:
        "https://bafkreih3ln6ys7nvgb3sf5tg52v6rat7363si2wwqgurp3vfj3d43xpdqa.ipfs.nftstorage.link/",
...
export const getCollectionByIndex = (index, chainId) => {
  ...
  return collections
    ? collections.find((collection) => collection.index === parseInt(index))
    : {};
};
